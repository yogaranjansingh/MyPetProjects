...
public class S3SelectExample {
	...
	private static final String JSON_OBJECT_KEY = "sample.json";
	private static final String S3_SELECT_RESULTS_PATH = "sampleOutput.json";
	...
	//private static final String QUERY = "Select * from S3Object s where s.name='Susan Smith' ";
	...
	public static void main(String[] args) throws Exception {
		...
		SelectObjectContentRequest request = generateBaseJSONRequest(BUCKET_NAME, JSON_OBJECT_KEY, QUERY);
